...
const KeyboardAwareMixin = {
  ...
  componentDidMount: function () {
    // Keyboard events
    const keyboadShowEvent = Platform.OS === 'ios' ? 'keyboardWillShow' : 'keyboardDidShow'
    const keyboardHideEvent = Platform.OS === 'ios' ? 'keyboardWillHide' :'keyboardDidHide'

    this.keyboardWillShowEvent = Keyboard.addListener(keyboardShowEvent, this.updateKeyboardSpace)
    this.keyboardWillHideEvent = Keyboard.addListener(keyboardHideEvent, this.resetKeyboardSpace)
  },
